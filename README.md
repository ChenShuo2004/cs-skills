...
> 把中文内容里最重要的判断、关系和转折，画成一张张白底、轻手绘、带有小黄行动的正文配图。
>
> 16:9 横版 · 小黄 IP · 白底黑线 · 少量红橙蓝批注 · Codex Skill

`$cs-xiaohuang-skill` 不是通用生图 Prompt，也不是 PPT 模板。它先从文章里找出真正值得被理解的**认知锚点**，再把一个判断、变化、关系或隐喻，变成读者一眼能看懂的动作。

一句话：让 AI 不只是替文章“添一张图”，而是把读者最该理解的那一步画出来。

### 适合与边界

适合：

- 中文文章、公众号、博客、Notion、知识型帖子和方法论内容的正文配图。
- 需要把抽象观点、前后变化、输入输出、瓶颈、反馈或路线选择画成具体隐喻的内容。
- 希望建立白底、轻手绘、有角色参与的稳定视觉语言的创作者。

不适合：

- 商业 KV、品牌海报、课程页、PPT 信息图或复杂架构图。
- 需要严格可编辑 SVG、HTML、Canvas 或高精度流程图的场景。
- 把长段文字、完整课程或多个观点强塞进同一张图的需求。

### 它会产出什么

- 一篇文章的 3～6 张配图 shot list：插入位置、核心意思、构图类型、小黄动作和短标注建议。
- 逐张生成的 16:9 正文配图；每张只表达一个关系，不把多个概念拼在一起。
- 用户提供现有图片时，可做去标题、修错字或指定元素的局部编辑。

### 视觉规则

- 纯白背景、黑色轻手绘线条、大量留白；主体只占画面约 40%～60%。
- 小黄是暖黄色、黑色圆点眼和细手脚的内容操作员；它必须承担关键动作，不能只在角落卖萌。
- 红色只标记警示或结果，蓝色只标记反馈或状态；每张最多 6 个短中文标注。
- 保持“有点奇怪但很清楚”的产品草图感；不要做成商业插画、儿童卡通或培训课件。

### 示例效果

这些图用于校准小黄的参与方式、留白和信息密度，不是可复刻的构图模板。每次使用都应从当前内容重新发明一个成立的隐喻。

#### 认知锚点

从一堆信息中只照亮最值得讲清的一张。

![小黄用手电筒选择认知锚点](assets/cs-xiaohuang-skill/01-cognitive-anchor.png)

#### 一图一事

把缠在一起的表达剪开，只保留一个能够进入画框的意思。

![小黄剪开复杂表达，只保留一个意思](assets/cs-xiaohuang-skill/02-one-idea.png)

#### 关系显影

不是堆素材，而是把“素材到结论”的关键连接画出来。

![小黄画出信息和结论之间的关系](assets/cs-xiaohuang-skill/03-relation-reveal.png)

#### 留白

删掉不必要的物件，让读者把注意力留给核心判断。

![小黄拉走杂物，为核心判断保留留白](assets/cs-xiaohuang-skill/04-negative-space.png)

#### 隐喻转译

把抽象、难讲清的想法，转成一个可见、可感的物理关系。

![小黄将抽象想法投影为可见关系](assets/cs-xiaohuang-skill/05-metaphor-translation.png)

#### 克制标注

把长解释压缩成少量短词，让图自己完成大部分表达。

![小黄将长标注裁成少量短标签](assets/cs-xiaohuang-skill/06-concise-labels.png)

#### 逐张生成

每个认知锚点单独成图，不把一堆观点硬拼到同一张画布。

![小黄逐张挂起独立画框](assets/cs-xiaohuang-skill/07-one-by-one.png)

#### 交付前检查

在保存前检查白底、留白、小黄动作、短标注和非 PPT 感。

![小黄在交付前检查正文配图](assets/cs-xiaohuang-skill/08-quality-check.png)
